...
// MySecondProjectMFC.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CMySecondProjectMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CMySecondProjectMFCApp

CMySecondProjectMFCApp::CMySecondProjectMFCApp()
{
...
// Le seul et unique objet CMySecondProjectMFCApp

CMySecondProjectMFCApp theApp;


// Initialisation de CMySecondProjectMFCApp

BOOL CMySecondProjectMFCApp::InitInstance()
{
